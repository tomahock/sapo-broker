...
public class NetBrokerMessage
{
	...
	{
		return "NetBrokerMessage{" + "messageId=" + messageId + ", expiration=" + expiration + ", timestamp=" + timestamp + ", deferredDelivery=" + deferredDelivery + ", headers=" + headers + ", payload=" + new String(payload, Charset.defaultCharset()) + '}';
	}
