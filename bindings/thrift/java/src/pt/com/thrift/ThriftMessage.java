...
public class ThriftMessage implements TBase, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("ThriftMessage");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(ThriftMessage.class, metaDataMap);
  }
