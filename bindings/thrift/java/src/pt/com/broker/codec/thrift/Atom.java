...
public class Atom implements TBase, java.io.Serializable, Cloneable
{
	...
	{
		{
			put(HEADER, new FieldMetaData("header", TFieldRequirementType.OPTIONAL, new StructMetaData(TType.STRUCT, Header.class)));
			put(ACTION, new FieldMetaData("action", TFieldRequirementType.DEFAULT, new StructMetaData(TType.STRUCT, Action.class)));
		}
	});
	...
	public Atom(Header header, Action action)
	{
		this();
		this.header = header;
		this.action = action;
	...
	// Returns true if field header is set (has been asigned a value) and false
	// otherwise
	...
	// Returns true if field action is set (has been asigned a value) and false
	// otherwise
