...
public class Header implements TBase, java.io.Serializable, Cloneable
{
	...
	{
		{
			put(PARAMETERS, new FieldMetaData("parameters", TFieldRequirementType.DEFAULT, new MapMetaData(TType.MAP, new FieldValueMetaData(TType.STRING), new FieldValueMetaData(TType.STRING))));
		}
	});
	...
	// Returns true if field parameters is set (has been asigned a value) and
	// false otherwise
