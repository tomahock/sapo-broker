...
public class Authentication implements TBase, java.io.Serializable, Cloneable
{
	...
	{
		{
			...
			put(ROLES, new FieldMetaData("roles", TFieldRequirementType.OPTIONAL, new ListMetaData(TType.LIST, new FieldValueMetaData(TType.STRING))));
		}
	});
	...
	public Authentication(String authentication_type, byte[] token, String user_id, List<String> roles)
	{
		this();
	...
	// Returns true if field roles is set (has been asigned a value) and false
	// otherwise
