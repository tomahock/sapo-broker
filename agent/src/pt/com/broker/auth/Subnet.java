...
public class Subnet
{
	...
	/**
	 * Creates a subnet from CIDR notation. For example, the subnet 192.168.0.0/24 would be created using the {@link InetAddress} 192.168.0.0 and the mask 24.
	 * 
	 * @param subnet
	 *            The {@link InetAddress} of the subnet
	 * @param mask
	 *            The mask
	 */
