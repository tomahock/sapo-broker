...
using SapoBrokerClient.Authentication.SapoSTS;
using Samples.Utils;
...
namespace Samples.Consumers
{
    ...
    class StsAuthConsumer
    {
        ...
        {
            Console.WriteLine("SapoSTS authenticated Consumer test");
            ...
            ICredentialsProvider provider = new SapoStsProvider("jose.saramago.276537@gmail.com", "saramago_jose");
