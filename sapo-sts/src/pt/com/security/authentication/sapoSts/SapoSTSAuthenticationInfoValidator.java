...
public class SapoSTSAuthenticationInfoValidator implements ClientAuthenticationInfoValidator
{
	...
	private static final SapoSTEClientAuthenticationInfoValidationResult invalidToken = new SapoSTEClientAuthenticationInfoValidationResult("Invalid Token");
	private static final SapoSTEClientAuthenticationInfoValidationResult tokenExpired = new SapoSTEClientAuthenticationInfoValidationResult("Token Expired");
	private static final SapoSTEClientAuthenticationInfoValidationResult internalError = new SapoSTEClientAuthenticationInfoValidationResult("Internal error");

	@Override
	public ClientAuthenticationInfoValidationResult validate(ClientAuthInfo clientAuthInfo) throws Exception
	{
		URL url = new URL(getConnectionUrl(clientAuthInfo, SapoSTSBrokerAuthenticationService.getAgentAuthenticationInfo()));
	...
	public void init()
	{
		SapoSTSBrokerAuthenticationService.start();
	}
