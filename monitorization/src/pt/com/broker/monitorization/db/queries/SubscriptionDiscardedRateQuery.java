...
public class SubscriptionDiscardedRateQuery extends StaticQuery
{

	private final static String SUBSCRIPTION_PARAM = "subscriptionname";
	private final static String QUERY = "SELECT last_event_for_subject_and_predicate(?, 'discarded-rate', generate_series, '00:01')  FROM generate_series(now()- time '00:20',  now(), '00:01'::time)";
