...
/**
 * CREDIT
 * The author of the code within RJH.CommandLineHelper namespace is Ray Hayes.
 * It was downloaded from http://www.codeproject.com/KB/recipes/commandlineparser.aspx
 * 
 */

namespace RJH.CommandLineHelper
{
	/// <summary>Implementation of a command-line parsing class.  IsClosed capable of
