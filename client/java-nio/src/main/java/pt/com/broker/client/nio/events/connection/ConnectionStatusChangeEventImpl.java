...
/**
 * The ConnectionStatusChangeEvent represents a connection status change. This events
 * are triggered when a connection state change event occurs and are delivered to any
 * listeners added to the client.
 * */
