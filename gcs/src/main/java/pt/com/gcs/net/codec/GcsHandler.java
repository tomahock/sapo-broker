...
/**
 * This Decoder main responsibility is to detect SSL/TLS support for the channel. If the channel supports SSL/TLS, the SSL Handler is added to the pipeline, otherwise all agent communications are unsecured.
 * */
