...
public class StatisticsCollector implements Runnable
{
	...
	/**
	 * Collects and resets the statistics counter. The counter values for the different statistics available are placed on a hashmap and are passed to specific formater classes that serialize the values in the correct format and sends them to the right place.
	 * */
