...
public class TopicPubSubWithActionId extends Test
{
	...
	public TopicPubSubWithActionId()
	{
		...
		try
		{
			infoConsumer = new BrokerClient("127.0.0.1", 3323, "tcp://mycompany.com/mypublisher");
			infoProducer = new BrokerClient("127.0.0.1", 3323, "tcp://mycompany.com/mypublisher");
		}
		catch (Throwable t)
		{
