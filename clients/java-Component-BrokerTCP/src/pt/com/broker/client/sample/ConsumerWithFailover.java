...
public class ConsumerWithFailover implements BrokerListener
{
	...
	public static void main(String[] args) throws Throwable
	{
		...
		hosts.add( new HostInfo("localhost", 3423, 0) );
		hosts.add( new HostInfo("localhost", 3323, 0) );
		
		BrokerClient bk = new BrokerClient(hosts, "tcp://mycompany.com/mysniffer", NetProtocolType.THRIFT, null, null);
