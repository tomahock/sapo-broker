...
import pt.com.broker.bayeuxbridge.configuration.Clouds;
import pt.com.broker.bayeuxbridge.configuration.ConfigurationInfo;
import pt.com.broker.bayeuxbridge.configuration.Clouds.Cloud;
	...
	public static synchronized boolean init()
	{
		for(Clouds _clouds : ConfigurationInfo.getConfiguration().getBrokerClouds() )
		{
			...
			for(Cloud cloud : _clouds.getCloud())
			{
				...
				for(pt.com.broker.bayeuxbridge.configuration.Clouds.Cloud.Agent agent : cloud.getAgent())
				{
